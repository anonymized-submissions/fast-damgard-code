...
void hashF4_(mpz_t hsh, mpz_t elt1, mpz_t elt2, mpz_t elt3, mpz_t elt4)
{
    SHA512_CTX c;
    SHA512_Init(&c);
    ...
    char *selt4 = (char*) malloc(2 + mpz_sizeinbase(elt4, 10));
    mpz_get_str(selt4, 10, elt4);
    //printf("L3:%d %d \n", (int)mpz_sizeinbase(elt3, 10), (int)strlen(selt3));
    SHA512_Update(&c, selt4, (int)strlen(selt4));
